...
public class Bluetooth extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    public DeviceListUpdater mDeviceListAdapter;
    ...
    private BroadcastReceiver mBroadcastReceiver3 = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals(BluetoothDevice.ACTION_FOUND)){
                ...
                mDeviceListAdapter = new DeviceListUpdater(context, R.layout.device_adapter_view, mBTDevices);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView mBlueIv = findViewById(R.id.bluetoothIv);
